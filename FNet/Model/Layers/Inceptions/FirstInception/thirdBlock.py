...
def block3x3(input):
    tensor = factory.convolutionBlock(input, 'inception_3c_3x3_', '1', 128, (1,1))
    tensor = factory.zeroPadding(tensor)
    tensor = factory.convolutionBlock(tensor, 'inception_3c_3x3_', '2', 256, (3,3), (2,2))

    return tensor

def block5x5(input):
    tensor = factory.convolutionBlock(input, 'inception_3c_5x5_', '1', 32, (1,1))
    tensor = factory.zeroPadding(tensor, (2,2))
    tensor = factory.convolutionBlock(tensor, 'inception_3c_5x5_', '2', 64, (5,5), (2,2))
